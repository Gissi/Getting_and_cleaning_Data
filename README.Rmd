...
2. Codebook.rmd - This is a markdown file explaining all the code in run_analysis.r in more detail. Here the variables are explained and all the trasnformation made to the code. 
